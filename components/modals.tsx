...
const WALLET_LOGOS = {
  phantom: "https://raw.githubusercontent.com/phantom/solana-wallet-logos/main/phantom.png",
  solflare: "https://raw.githubusercontent.com/solflare-wallet/solana-wallet-logos/main/solflare.png",
  backpack: "https://raw.githubusercontent.com/coral-xyz/backpack/main/public/icon.png",
  sollet: "https://raw.githubusercontent.com/project-serum/sol-wallet-adapter/master/packages/wallets/icons/sollet.svg",
  mathwallet: "https://raw.githubusercontent.com/mathwallet/math-wallet-adapter/master/packages/wallets/icons/mathwallet.svg",
}

const DEFAULT_LOGO = "https://raw.githubusercontent.com/solana-labs/wallet-adapter/master/packages/wallets/icons/solana.svg"
...
export function Modals({ isOpen, onClose }: ModalsProps) {
  ...
  const getWalletLogo = (walletId: string) => {
    ...
    return WALLET_LOGOS[walletId as keyof typeof WALLET_LOGOS] || DEFAULT_LOGO
  }
